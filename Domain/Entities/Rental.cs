...
public class Rental : Entity<Guid>
{
    ...
    public RentalBranch RentStartRentalBranch { get; set; }
    public RentalBranch? RentEndRentalBranch { get; set; }
    public ICollection<RentalsAdditionalService> RentalsAdditionalServices { get; set; }
